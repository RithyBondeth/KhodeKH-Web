      ...
      <div className="max-w-6xl mx-auto">
        <AnimateIn animation="fade-up" className="text-center mb-16">
          <TypographyH2 className="text-4xl font-bold tracking-tight mb-4 text-foreground border-0 pb-0">
            Loved by <span className="gradient-text">Cambodian Developers</span>
          </TypographyH2>
        </AnimateIn>
            ...
            >
              <div className="card-surface rounded-2xl p-6 h-full flex flex-col">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <TypographySmall className="font-semibold text-foreground block">{t.name}</TypographySmall>
                    <TypographyMuted className="text-xs">{t.nameKh}</TypographyMuted>
                    <TypographyMuted className="text-xs opacity-70">{t.role}</TypographyMuted>
                  </div>
                </div>
              </div>
            </AnimateIn>
